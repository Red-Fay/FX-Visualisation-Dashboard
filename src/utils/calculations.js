...
const calculateRSI = (prices, period = 14) => {
  ...
  // Fill initial null values with the first calculated RSI
  const firstValidRsi = rsiValues.find(val => val !== null);
  return rsiValues.map(val => val === null ? firstValidRsi : val);
};
 ...
 */
const calculateRateDifferential = (baseRates, quoteRates) => {
